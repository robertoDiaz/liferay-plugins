YUI.add('aui-image-processor-swf', function (A, NAME) {
...
var Lang = A.Lang,
    ...
    _NAME = 'image-processor-swf',

    /**
     * A js wrapper for a FLASH implementation of an ImageProcessor
     *
     * @class A.ImageProcessorSWF
     * @extends A.ImageProcessorBase
     * @constructor
     */
    ImageProcessorSWF = A.Base.create(_NAME, A.ImageProcessorBase, [], {
        ...
        initializer: function() {
            ...
            instance.set('swfHeight', imageNode.height().toString());
            instance.set('swfWidth', imageNode.width().toString());

            srcNode.empty();
            srcNode.append(instance._filterSwf);
            instance._renderSwf();
        },
        ...
        _renderSwf: function() {
            ...
            if (swfUrl) {
                ...
                flashVars['imageUrl'] = imageNode.attr('src');
...
A.ImageProcessorSWF = ImageProcessorSWF;
